...
class ypScraper:
    ...
    def __init__(self):
        ...
        self.searchProvince = input(
            "Enter province/territory of city(AB, BC, MB, NB, NL, NT, NS, NU, ON, PE, QC, SK, YT): ")
    ...
    def createFile(self):
        ...
        self.csvFile.write(
            "Number, Name, Address, Phone Number, Website," + "Data Extracted On: " + datetime.now().strftime(
                '%Y-%m-%d %H:%M:%S') + "," + "URL: " + self.url + "\n")
    ...
    def addInfo(self, listings):
        ...
        for business in listings:
            ...
            self.csvFile.write(
                str(num) + "," + businessName + "," + businessAddress + "," + businessPhone + "," + businessWebsite + "\n")
